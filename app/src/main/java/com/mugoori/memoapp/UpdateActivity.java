...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Memo getMemo = (Memo) getIntent().getSerializableExtra("memo");

        // {"2023-08-03", "11:30"}
        String[] dateArray = getMemo.getDatetime().substring(0,15+1).split("T");
        date = dateArray[0];
        time = dateArray[1];

        editTitle.setText(getMemo.getTitle());
        editContent.setText(getMemo.getContent());
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(title.isEmpty() || content.isEmpty() ||
                    ...
                    Toast.makeText(UpdateActivity.this, "모든 항목은 필수입니다.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Call<Res> call = api.updateMemo(getMemo.getId(), accessToken, memo);
                ...
                call.enqueue(new Callback<Res>() {
                    ...
                    public void onResponse(Call<Res> call, Response<Res> response) {
                        ...
                        if(response.isSuccessful()){
                            ...
                            Toast.makeText(UpdateActivity.this, "정상동작하지 않았습니다.", Toast.LENGTH_SHORT).show();
                            return;
                        }
